...
export default function ParentDashboardScreenshot() {
  ...
  return (
    <svg viewBox="0 0 900 560" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x={mx(55)} y="33" textAnchor={startAnchor} fill="white" fontSize="13" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.brandVoice')}</text>
      <text x={mx(92)} y="33" textAnchor={startAnchor} fill="#a78bfa" fontSize="13" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.brandBridge')}</text>
      <text x={mx(55)} y="47" textAnchor={startAnchor} fill="#6d6aff" fontSize="9" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.parentAccountLabel')}</text>
      ...
      {[
        ...
        <g key={label}>
          ...
          <text x={mx(20)} y={y + 6} textAnchor={startAnchor} fill={active ? 'white' : '#94a3b8'} fontSize="14" fontFamily="Inter, sans-serif">{icon}</text>
          <text x={mx(44)} y={y + 6} textAnchor={startAnchor} fill={active ? 'white' : '#94a3b8'} fontSize="12" fontFamily="Inter, sans-serif">{label}</text>
        </g>
      ))}
      ...
      <text x={mx(50)} y="511" textAnchor={startAnchor} fill="white" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.userName')}</text>
      <text x={mx(50)} y="526" textAnchor={startAnchor} fill="#a78bfa" fontSize="10" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.userRole')}</text>

      {/* Main content */}
      {/* Top bar */}
      <rect x={mxRect(200, 700)} y="0" width="700" height="56" fill="white" />
      <rect x={mxRect(200, 700)} y="55" width="700" height="1" fill="#e2e8f0" />
      <text x={mx(220)} y="33" textAnchor={startAnchor} fill="#1e293b" fontSize="18" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.greeting')}</text>
      <text x={mx(220)} y="49" textAnchor={startAnchor} fill="#94a3b8" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.dateLabel')}</text>
      ...
      {[
        ...
        <g key={label}>
          ...
          <text x={mx(x + 16)} y="104" textAnchor={startAnchor} fill="#1e293b" fontSize="28" fontWeight="800" fontFamily="Inter, sans-serif">{value}</text>
          <text x={mx(x + 16)} y="122" textAnchor={startAnchor} fill="#64748b" fontSize="11" fontFamily="Inter, sans-serif">{label}</text>
          <text x={mx(x + 150)} y="104" textAnchor={startAnchor} fontSize="22" fontFamily="Inter, sans-serif">{icon}</text>
        </g>
      ))}

      {/* Children profiles */}
      <text x={mx(220)} y="180" textAnchor={startAnchor} fill="#1e293b" fontSize="14" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.myChildrenTitle')}</text>
      ...
      <text x={mx(293)} y="220" textAnchor={startAnchor} fill="#1e293b" fontSize="14" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.child1Name')}</text>
      <text x={mx(293)} y="237" textAnchor={startAnchor} fill="#7c3aed" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.child1Info')}</text>
      ...
      <text x={mx(583)} y="220" textAnchor={startAnchor} fill="#1e293b" fontSize="14" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.child2Name')}</text>
      <text x={mx(583)} y="237" textAnchor={startAnchor} fill="#ec4899" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.child2Info')}</text>
      ...
      {/* Recent Activity */}
      <text x={mx(220)} y="330" textAnchor={startAnchor} fill="#1e293b" fontSize="14" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.recentActivityTitle')}</text>
      <text x={mx(820)} y="330" textAnchor={startAnchor} fill="#7c3aed" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.parentDashboardScreenshot.viewAll')}</text>
      ...
      {[
        ...
        <g key={i}>
          ...
          <text x={mx(264)} y={369 + i * 56} textAnchor={startAnchor} fill="#64748b" fontSize="11" fontFamily="Inter, sans-serif">{child}</text>
          <text x={mx(264)} y={383 + i * 56} textAnchor={startAnchor} fill="#1e293b" fontSize="13" fontWeight="600" fontFamily="Inter, sans-serif">{card}</text>
          <text x={mx(760)} y={369 + i * 56} textAnchor={startAnchor} fill="#94a3b8" fontSize="10" fontFamily="Inter, sans-serif">{time}</text>
          {ack ? (
            <>
