...
export default function CardConfigScreenshot() {
  ...
  return (
    <svg viewBox="0 0 390 700" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x={mx(20)} y="24" textAnchor={startAnchor} fill="white" fontSize="18" fontFamily="Inter, sans-serif">{rtl ? '→' : '←'}</text>
      ...
      <text x={mx(36)} y="92" textAnchor={startAnchor} fill="#94a3b8" fontSize="13" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.searchPlaceholder')}</text>
      ...
      {[
        ...
        <g key={title}>
          ...
          {/* Drag handle */}
          <text x={mx(30)} y={184 + i * 72} textAnchor={startAnchor} fill="#d1d5db" fontSize="14" fontFamily="Inter, sans-serif">⋮⋮</text>
          ...
          {/* Text */}
          <text x={mx(100)} y={176 + i * 72} textAnchor={startAnchor} fill="#1e293b" fontSize="13" fontWeight="600" fontFamily="Inter, sans-serif">{title}</text>
          <text x={mx(100)} y={192 + i * 72} textAnchor={startAnchor} fill="#94a3b8" fontSize="11" fontFamily="Inter, sans-serif">"{phrase}"</text>
          ...
          {/* Edit button */}
          <text x={mx(358)} y={187 + i * 72} textAnchor={startAnchor} fill="#94a3b8" fontSize="13" fontFamily="Inter, sans-serif">✏️</text>
        </g>
      ))}
