...
export default function CardConfigScreenshot() {
  ...
  return (
    <svg viewBox="0 0 390 700" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x="195" y="30" textAnchor="middle" fill="white" fontSize="15" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.headerTitle')}</text>
      <text x="195" y="46" textAnchor="middle" fill="#ddd6fe" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.headerSubtitle')}</text>
      <rect x="340" y="14" width="36" height="28" rx="8" fill="white" fillOpacity="0.2" />
      <text x="358" y="33" textAnchor="middle" fill="white" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.addButton')}</text>

      {/* Search bar */}
      <rect x="16" y="68" width="358" height="38" rx="10" fill="white" stroke="#e2e8f0" strokeWidth="1.5" />
      <text x="36" y="92" fill="#94a3b8" fontSize="13" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.searchPlaceholder')}</text>

      {/* Filter chips */}
      <rect x="16" y="116" width="68" height="26" rx="13" fill="#7c3aed" />
      <text x="50" y="133" textAnchor="middle" fill="white" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.filterAll')}</text>
      <rect x="94" y="116" width="68" height="26" rx="13" fill="white" stroke="#e2e8f0" strokeWidth="1.5" />
      <text x="128" y="133" textAnchor="middle" fill="#6b7280" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.filterActive')}</text>
      <rect x="172" y="116" width="76" height="26" rx="13" fill="white" stroke="#e2e8f0" strokeWidth="1.5" />
      <text x="210" y="133" textAnchor="middle" fill="#6b7280" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.filterHidden')}</text>
      <rect x="258" y="116" width="74" height="26" rx="13" fill="white" stroke="#e2e8f0" strokeWidth="1.5" />
      <text x="295" y="133" textAnchor="middle" fill="#6b7280" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.filterCustom')}</text>
      ...
      <text x="195" y="636" textAnchor="middle" fill="#7c3aed" fontSize="12" fontWeight="600" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.addCustomCard')}</text>

      {/* Save button */}
      <rect x="16" y="658" width="358" height="46" rx="12" fill="url(#cardConfigGrad)" />
      <text x="195" y="686" textAnchor="middle" fill="white" fontSize="14" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.cardConfigScreenshot.saveChanges')}</text>
