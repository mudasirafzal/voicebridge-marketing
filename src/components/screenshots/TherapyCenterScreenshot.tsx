...
export default function TherapyCenterScreenshot() {
  ...
  return (
    <svg viewBox="0 0 900 560" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x={mx(55)} y="31" textAnchor={startAnchor} fill="white" fontSize="12" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.brandName')}</text>
      <text x={mx(55)} y="46" textAnchor={startAnchor} fill="#64748b" fontSize="9" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.brandRole')}</text>
      ...
      {[
        ...
        <g key={label}>
          ...
          <text x={mx(20)} y={y + 4} textAnchor={startAnchor} fill={active ? 'white' : '#64748b'} fontSize="13" fontFamily="Inter, sans-serif">{icon}</text>
          <text x={mx(44)} y={y + 4} textAnchor={startAnchor} fill={active ? 'white' : '#64748b'} fontSize="12" fontFamily="Inter, sans-serif">{label}</text>
        </g>
      ))}
      ...
      <text x={mx(52)} y="511" textAnchor={startAnchor} fill="white" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.userName')}</text>
      <text x={mx(52)} y="526" textAnchor={startAnchor} fill="#64748b" fontSize="10" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.userRole')}</text>

      {/* Top bar */}
      <rect x={mxRect(210, 690)} y="0" width="690" height="56" fill="white" />
      <rect x={mxRect(210, 690)} y="55" width="690" height="1" fill="#e2e8f0" />
      <text x={mx(228)} y="30" textAnchor={startAnchor} fill="#0f172a" fontSize="16" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.headerTitle')}</text>
      <text x={mx(228)} y="48" textAnchor={startAnchor} fill="#94a3b8" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.headerSubtitle')}</text>
      ...
      {[
        ...
        <g key={label}>
          ...
          <text x={mx(x + 14)} y="100" textAnchor={startAnchor} fill="#0f172a" fontSize="24" fontWeight="800" fontFamily="Inter, sans-serif">{value}</text>
          <text x={mx(x + 14)} y="116" textAnchor={startAnchor} fill="#475569" fontSize="10" fontFamily="Inter, sans-serif">{label}</text>
          <text x={mx(x + 14)} y="132" textAnchor={startAnchor} fill="#64748b" fontSize="9" fontFamily="Inter, sans-serif">{sub}</text>
          <text x={mx(x + 132)} y="100" textAnchor={startAnchor} fontSize="20" fontFamily="Inter, sans-serif">{icon}</text>
        </g>
      ))}

      {/* Families table */}
      <text x={mx(228)} y="172" textAnchor={startAnchor} fill="#0f172a" fontSize="13" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.registeredFamilies')}</text>
      ...
      {[
        ...
        <text key={h} x={mx([240, 360, 470, 570, 660, 760][i])} y="202" textAnchor={startAnchor} fill="#64748b" fontSize="10" fontWeight="600" fontFamily="Inter, sans-serif">{h}</text>
      ))}
      ...
      {[
        ...
        <g key={name}>
          ...
          <text x={mx(264)} y={239 + i * 40} textAnchor={startAnchor} fill="#0f172a" fontSize="12" fontWeight="600" fontFamily="Inter, sans-serif">{name}</text>
          <text x={mx(360)} y={239 + i * 40} textAnchor={startAnchor} fill="#475569" fontSize="11" fontFamily="Inter, sans-serif">{children}</text>
          <text x={mx(470)} y={239 + i * 40} textAnchor={startAnchor} fill="#475569" fontSize="11" fontFamily="Inter, sans-serif">{therapist}</text>
          <text x={mx(570)} y={239 + i * 40} textAnchor={startAnchor} fill="#94a3b8" fontSize="11" fontFamily="Inter, sans-serif">{last}</text>
          <circle cx={mx(656)} cy={234 + i * 40} r="4" fill={dot} />
          <text x={mx(666)} y={239 + i * 40} textAnchor={startAnchor} fill={dot === '#16a34a' ? '#16a34a' : '#d97706'} fontSize="11" fontFamily="Inter, sans-serif">{status}</text>
          <text x={mx(760)} y={239 + i * 40} textAnchor={startAnchor} fill="#7c3aed" fontSize="11" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.viewAction')}</text>
        </g>
      ))}
      ...
      <text x={mx(246)} y="410" textAnchor={startAnchor} fill="#0f172a" fontSize="12" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.assignTherapistTitle')}</text>
      <text x={mx(246)} y="426" textAnchor={startAnchor} fill="#94a3b8" fontSize="10" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.assignTherapistSub')}</text>
      {[
        ...
        <g key={name}>
          ...
          <text x={mx(254)} y={452 + i * 30} textAnchor={startAnchor} fill="#0f172a" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">{name}</text>
          <text x={mx(450)} y={452 + i * 30} textAnchor={startAnchor} fill="#64748b" fontSize="10" fontFamily="Inter, sans-serif">{count}</text>
        </g>
      ))}

      {/* Notification settings */}
      <rect x={mxRect(558, 322)} y="388" width="322" height="140" rx="12" fill="white" stroke="#e2e8f0" strokeWidth="1.5" />
      <text x={mx(576)} y="410" textAnchor={startAnchor} fill="#0f172a" fontSize="12" fontWeight="700" fontFamily="Inter, sans-serif">{t('screenshotMockups.therapyCenterScreenshot.notificationSettingsTitle')}</text>
      {[
        ...
        <g key={label}>
          <text x={mx(576)} y={438 + i * 38} textAnchor={startAnchor} fill="#374151" fontSize="11" fontFamily="Inter, sans-serif">{label}</text>
